...
pub use defense::{
    ...
    compressed_ron_capable_hidden_hand_weight, genbutsu_dahai_actions_for_all_reached,
    ...
    shanpon_remaining_combinations_for_player, suited_dahai_actions_by_safety,
