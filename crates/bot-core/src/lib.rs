...
pub use defense::{
    DefenseFallbackDiagnostic, DefenseFallbackKind, HonorSafetyRank, SuitedSafetyRank,
    SujiSafetyRank, WallRank, genbutsu_dahai_actions_for_all_reached,
    honor_dahai_actions_by_safety, honor_safety_rank, is_genbutsu_for, is_genbutsu_for_all_reached,
    is_no_chance, is_one_chance, is_suji_for, is_suji_for_all_reached, is_suji_for_any_reached,
    log_defense_fallback_decision, select_defense_fallback_action,
