...
pub use context::{
    DoubleRiichiFacts, GameContext, RiichiSituationFacts, TableStateFacts, seat_wind_for_player,
};
...
pub use defense::{
    ...
    SequenceWaitRoute, SequenceWaitShape, StructuralExpectedDealInLossDiagnostic,
    StructuralExpectedDealInLossEvidence, StructuralExpectedDealInLossMetrics,
    StructuralExpectedDealInLossUnavailable, SuitedSafetyEvidence, SuitedSafetyRank,
    SujiSafetyRank, TenpaiStateWeight, WallRank, compare_lexicographic_minimax_ron_risk,
    compressed_ron_capable_hidden_hand_weight, compressed_tenpai_hidden_hand_weight,
    diagnose_structural_expected_deal_in_loss, genbutsu_dahai_actions_for_all_reached,
    ...
    opponent_honor_value_for_players, opponent_honor_value_for_reached, remaining_tile_copies,
    ...
    shanpon_remaining_combinations_for_player, structural_expected_deal_in_loss,
    structural_expected_deal_in_loss_with_metrics, suited_dahai_actions_by_safety,
    ...
    suji_safety_rank_for_any_reached, suji_safety_rank_for_players, tanki_remaining_candidates,
...
pub use three_shanten_continuation_comparison::{
    ...
    compare_three_shanten_continuation_scopes, decide_with_three_shanten_continuation_scope,
    profile_three_shanten_continuation_scope,
};
