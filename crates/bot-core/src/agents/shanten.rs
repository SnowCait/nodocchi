...
use crate::tenpai_hand_change::TenpaiHandChangeDiagnostic;
use crate::threat::{
...
use bot_logic::{
    ...
    LookaheadDiagnostic, PermanentFuriten, SelfTsumoFacts, TenpaiWaitAvailability, TileType,
};
...
pub struct ShantenDecisionDiagnostic {
    ...
    /// 現在打牌後が聴牌の候補について、非和了ツモ1枚と最善打牌で再び聴牌になる「1回だけの
    /// 手変わり」。2手先診断を構築し、かつ自分が未リーチと確定している局面だけ持つ。
    ///
    ...
    /// 構築の有無は選択結果を変えない。
    pub normal_discard_tenpai_hand_change: Option<TenpaiHandChangeDiagnostic>,
...
struct DecisionDiagnostics {
    ...
    normal_discard_tenpai_hand_change: Option<TenpaiHandChangeDiagnostic>,
...
impl ShantenAgent {
    ...
    pub fn diagnose_with_options(
        ...
        ShantenDecisionDiagnostic {
            ...
            normal_discard_tenpai_hand_change: diagnostics.normal_discard_tenpai_hand_change,
    ...
    fn select_normal_discard(
        ...
        diagnostics.normal_discard_tenpai_hand_change = selection.tenpai_hand_change;
...
pub(crate) mod tests {
    ...
    fn lookahead_does_not_change_the_selected_action() {
        ...
        assert_eq!(
            ShantenDecisionDiagnostic {
                ...
                normal_discard_tenpai_hand_change: None,
                ..with
            },
            without
        );
    ...
    impl CallReaction {
        pub(crate) fn pon(hand: &[u8], target: u8, consumed: &[u8]) -> Self {
        ...
        pub(crate) fn call(&self) -> LegalAction {
    ...
    pub(crate) fn dragon_pon_reaction() -> CallReaction {
